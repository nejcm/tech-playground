        ...
        >
          ...
          <div className='space-y-2 text-sm'>
            ...
            <ol className='list-inside list-decimal space-y-2 text-indigo-300/80'>
              <li>
                Configure your <code className='rounded bg-black/30 px-2 py-1 text-purple-300'>DATABASE_URL</code> in
                .env.local
              </li>
              <li>
                Run: <code className='rounded bg-black/30 px-2 py-1 text-purple-300'>npx drizzle-kit generate</code>
              </li>
              <li>
                Run: <code className='rounded bg-black/30 px-2 py-1 text-purple-300'>npx drizzle-kit migrate</code>
              </li>
              <li>
                Optional: <code className='rounded bg-black/30 px-2 py-1 text-purple-300'>npx drizzle-kit studio</code>
              </li>
            </ol>
          </div>
        </div>
